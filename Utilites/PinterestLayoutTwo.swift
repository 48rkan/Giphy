...
//    func collectionView(_ collectionView: UICollectionView, layout: GiphyLayout,
...
//                attributes.frame = insetFrame
//                supplementaryCache.updateCollection(keyedBy: GiphyLayout.elementKindBanner, with: attributes)
//                contentBounds = contentBounds.union(frame)
